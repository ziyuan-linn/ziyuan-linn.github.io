class WorkApp extends Application {
    constructor() {
        super(0.15, 0.15, 0.7, 0.7, "Work");
    ...
    display() {
        ...
        if (!this.isHidden) {
            ...
            fill(0);
            text("Tasks Completed: " + this.tasksCompleted + "/15", (this.relX + 0.1695) * width, (this.relY + 0.685) * height);
        }
